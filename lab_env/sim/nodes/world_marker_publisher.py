...
from lab_env.sim.world.world_markers import MarkerPose, MarkerSpec, load_world_marker_specs, load_world_model_pose
...
def _apply_uav_pose(spec: MarkerSpec, *, current_pose: MarkerPose, local_offsets: dict[int, _LocalMarkerOffset]) -> MarkerSpec:
