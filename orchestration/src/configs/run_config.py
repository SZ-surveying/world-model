...
from src.configs.task_config import load_task_config_data, optional_task_table, resolve_task_config_path
...
class OrchestrationConfig:
    ...
    def load(
        ...
        *,
        ...
        task = optional_task_table(data, task_path)
        ...
        return cls(
            ...
            companion_image=_as_str(
                ...
                image_config.companion.image(cwd=project_paths.lab_root),
            ),
            ...
            sensor=SensorContainerConfig(
                ...
                image=_as_str(sensor.get("image"), image_config.gazebo_sensor.image(cwd=project_paths.lab_root)),
            ),
            slam=SlamContainerConfig(
                autostart=_as_bool(slam.get("autostart"), True),
                image=_as_str(slam.get("image"), image_config.slam.image(cwd=project_paths.lab_root)),
            ...
            official_baseline=OfficialBaselineConfig(
                ...
                runtime_image=_as_str(
                    ...
                    image_config.official_baseline.image(cwd=project_paths.lab_root),
                ),
            ...
            real_prepare=RealPrepareConfig(
                ...
                lidar=_real_prepare_service_from_config(
                    ...
                    default_command=(
                        ...
                        "-m navlab.real.companion.nodes.ydlidar_x2_scan "
                ...
                rangefinder_bridge=_real_prepare_service_from_config(
                    ...
                    default_command=(
                        ...
                        "-lc",
                        "source /opt/ros/humble/setup.bash && source install/setup.bash && "
                        "PYTHONPATH=.:$PWD/orchestration/.venv/lib/python3.11/site-packages:$PYTHONPATH /usr/bin/python3 "
                        "-m navlab.real.companion.nodes.rangefinder_bridge "
