...
from src.config import FoxgloveUploadConfig
from src.foxglove_upload import _upload_acceptance_rosbag
...
def test_upload_acceptance_rosbag_posts_link_then_puts_mcap(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("src.foxglove_upload.urlopen", fake_urlopen)
